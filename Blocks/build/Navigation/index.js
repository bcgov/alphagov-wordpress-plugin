...
function Edit({
  ...
  const memoizedParse = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useCallback)(content => (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_6__.parse)(content), []);
  const memoizedSerialize = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useCallback)(blocks => (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_6__.serialize)(blocks), []);
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
    ...
    if (typeof contentToParse === 'function') {
      const existingBlocks = registry.select(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.store).getBlocks(clientId);
